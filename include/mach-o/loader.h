...
#define PLATFORM_XROS 5
#define PLATFORM_BRIDGEOS 6
#define PLATFORM_IOSMAC 7
#define PLATFORM_IOSSIMULATOR 8
#define PLATFORM_TVOSSIMULATOR 9
#define PLATFORM_WATCHOSSIMULATOR 10
#define PLATFORM_DRIVERKIT 11
